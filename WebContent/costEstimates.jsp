	...
	<div class="container">
		...
		<div class="main-block">
			...
			<div class="block-title">
				...
				<div class="title-right"><span id="price"></span></div>
			</div>
			<br>
			<div id="list-car">
			</div>	<br>	
			...
			<div style="display:flex;justify-content: space-between;width:100%">
			  	...
			  	<div><span id = "feeTax"></span></div>
			 </div> 
			  <br>
			  <div style="display:flex;justify-content: space-between;width:100%">
			  	<div>Phí đăng kiểm</div>
			  	<div><span id = "feeRegistration"></span></div>
			 </div> 
			  <br>
			  <div style="display:flex;justify-content: space-between;width:100%">
			  	<div>Phí đường bộ</div>
			  	<div><span id = "feeRoadFee"></span></div>
			 </div> 
			  <br>
			  <div style="display:flex;justify-content: space-between;width:100%">
			  	<div>Phí bảo hiểm dân sự</div>
			  	<div><span id = "feeInsurrance"></span></div>
			 </div> 
			  <br>
			  <div style="display:flex;justify-content: space-between;width:100%">
			  	<div>Phí biển số</div>
			  	<div><span id = "feeLicensePlate"></span></div>
			 </div> 
			  <br>	
			...
			<p>Phí bảo hiểm vật chất quý khách có thể tự lựa chọn công ty bảo hiểm hoặc liên hệ tư vấn Hotline:  0343542277</p><br>
			 <div class="block-title">
				...
				<div class="title-right"><span id = "totalFee"></span></div>
			</div>
			<br>
			 <div class="block-title">
				<div class="title-left">Tổng giá xe + (Phí)</div>
				<div class="title-right"><span id = "total"></span></div>
			</div>
			<br>
		</div>
		<br>
