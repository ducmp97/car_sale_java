        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <p><br></p>
                        <h1 class="page-header" style="padding-right:600px">User List</h1>
                        <p><br></p>
                    </div>
                    <div id="prlist">
                        <h3>Add Use</h3>
                        <i class="fa fa-plus" aria-hidden="true"></i>&nbsp<a href="use_add.html">Add</a>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            <tr class="odd gradeX" align="center">
                                ...
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="use_edit.html">Edit</a></td>
                            </tr>
